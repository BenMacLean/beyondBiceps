		...
		<div class="comment-text">
			...
			<?php else : ?>
				...
				<div class="meta clearfix">
					<span class="review-author" itemprop="author"><?php comment_author(); ?></span> <?php
					...
					<time class="review-date" itemprop="datePublished" datetime="<?php echo get_comment_date( 'c' ); ?>"><?php echo get_comment_date( wc_date_format() ); ?></time>
				</div>
